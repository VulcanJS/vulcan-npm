...
interface FormWrapperProps {
  ...
  typeName: string; // TODO: do we need this? get from model if graphql?
  // for edition
  documentId?: string;
  slug?: string;
  // projection
  ...
  Components: PossibleCoreComponents;
...
export const FormWrapper = (props: FormWrapperProps) => {
  const { schema: schemaFromProps, model, documentId, slug } = props;
  const schema = schemaFromProps || model.schema;
  ...
  //const getFragments = () => {
  const { fields, addFields, typeName } = props;
